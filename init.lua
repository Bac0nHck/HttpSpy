...
local Serializer = loadstring(game:HttpGet("https://raw.githubusercontent.com/Bac0nHck/HttpSpy/refs/heads/main/Serializer"))();
...
local RecentCommit = game.HttpService:JSONDecode(game:HttpGet("https://raw.githubusercontent.com/Bac0nHck/HttpSpy/refs/heads/main/RecentCommit"))[1].commit.message;
